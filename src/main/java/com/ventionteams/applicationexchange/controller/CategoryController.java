...
public class CategoryController {
    ...
    public ResponseEntity<PageResponse<LotReadDTO>> findLotsWithFilter(@RequestParam(defaultValue = "1") Integer page,
                                                                       ...
                                                                       @RequestParam(required = false) @Min(1) @Max(10000) Long fromQuantity,
                                                                       @RequestParam(required = false) @Min(1) @Max(10000) Long toQuantity,
                                                                       @RequestParam(required = false) @Min(1) @Max(1000) Integer fromSize,
                                                                       @RequestParam(required = false) @Min(1) @Max(1000) Integer toSize,
                                                                       @RequestParam(required = false) @Min(1) @Max(1000000) Integer fromPrice,
                                                                       @RequestParam(required = false) @Min(1) @Max(1000000) Integer toPrice,
